...
1. Commit:
OOP architektúra: Létrejött az alap entitásrendszer (BaseEntity), amely egységes életerő- és csapatkezelést biztosít.

Mozgás és Harc: A Unit osztály képes az automatikus mozgásra és a Coroutine alapú, időzített sebzésosztásra.
